...
async function testAuthenticationAndRegistration() {
  ...
  if (!adminToken) {
    ...
    for (const userType of userTypes) {
      const email = `${userType.toLowerCase().replace(/_/g, '.')}-${UNIQUE_SUFFIX}@testerp.com`;
  ...
  const employees = [
    {
      firstName: 'John',
      lastName: 'Doe',
      email: `john.doe-${UNIQUE_SUFFIX}@testerp.com`,
      phone: '1234567890',
      dateOfBirth: '1990-01-15',
      joiningDate: '2024-01-01',
      position: 'Senior Developer',
      departmentId: testData.departmentIds[2] || testData.departmentIds[0], // IT or first available
      salary: 80000
    },
    {
      firstName: 'Jane',
      lastName: 'Smith',
      email: `jane.smith-${UNIQUE_SUFFIX}@testerp.com`,
      phone: '1234567891',
      dateOfBirth: '1992-05-20',
      joiningDate: '2024-02-01',
      position: 'HR Executive',
      departmentId: testData.departmentIds[0], // HR
      salary: 60000
    },
    {
      firstName: 'Bob',
      lastName: 'Johnson',
      email: `bob.johnson-${UNIQUE_SUFFIX}@testerp.com`,
      phone: '1234567892',
      dateOfBirth: '1988-08-10',
      joiningDate: '2024-01-15',
      position: 'Sales Manager',
      departmentId: testData.departmentIds[3] || testData.departmentIds[0], // Sales or first available
      salary: 90000
    }
  ];
  ...
  const leads = [
    {
      firstName: 'Michael',
      lastName: 'Brown',
      email: 'michael.brown@prospect.com',
      phone: '+1-555-2001',
    ...
    },
    {
      firstName: 'Sarah',
      lastName: 'Wilson',
      email: 'sarah.wilson@newclient.com',
      phone: '+1-555-2002',
